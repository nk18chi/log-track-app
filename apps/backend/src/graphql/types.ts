...
export type ResolversTypes = {
  ...
  OptimizedUser: ResolverTypeWrapper<Omit<OptimizedUser, 'followers' | 'following'> & { followers?: Maybe<Array<Maybe<ResolversTypes['User']>>>, following?: Maybe<Array<Maybe<ResolversTypes['User']>>> }>;
...
export type ResolversParentTypes = {
  ...
  OptimizedUser: Omit<OptimizedUser, 'followers' | 'following'> & { followers?: Maybe<Array<Maybe<ResolversParentTypes['User']>>>, following?: Maybe<Array<Maybe<ResolversParentTypes['User']>>> };
  PageInfo: PageInfo;
  Query: {};
...
export type OptimizedUserResolvers<ContextType = Context, ParentType extends ResolversParentTypes['OptimizedUser'] = ResolversParentTypes['OptimizedUser']> = {
